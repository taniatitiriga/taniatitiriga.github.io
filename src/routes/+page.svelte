...
<script lang="ts">
	...
	$: showContent = !isAnimating && $page.url.pathname === ($page.data.base || '') + '/';
</script>

<svelte:head>
	<title>Taniusca - Home</title>
	<meta name="description" content="Homepage with an interactive background." />
</svelte:head>
